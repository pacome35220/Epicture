...
const sortWindowPageFilters = [sortFilter, windowFilter, pageFilter];

interface ImgurRouteArg {
    name: string;
    type: string;
    value?: string;
}

export interface ImgurRoute {
    name: string;
    url: string | ((suffix: string) => string);
    args?: ImgurRouteArg[];
    headers?: any;
    httpMethod?: string;
    opts?: string[];
...
export const routes: ImgurRoute[] = [
    {
